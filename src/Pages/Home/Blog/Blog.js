...
const Blog = () => {
    return ( <
        ...
        <
        h5 className = "card-title" > Pfizer - BioNTech ask EU agency to OK vaccine
        for kids 5 - 11 < /h5> <
        p className = "card-text" >
        Pharmaceutical company Pfizer BioNTech said Friday they have requested to have their coronavirus vaccine licensed
        for children ages 5 to 11 across the European Union.Pfizer - BioNTech ask EU agency to OK vaccine
        for kids 5 - 11 <
        /p> <
        p className = "card-text" >
        <
        small className = "text-muted" >
        Written by Sumaiya Sumu. <
        /small> <
        /p> <
        /div> <
        /div> <
